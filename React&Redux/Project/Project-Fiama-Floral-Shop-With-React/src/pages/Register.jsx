...
import { createUser } from 'src/api/Services'
// import { registerSchema } from 'src/assets/schemas/schema'
            ...
            <section className="register-section">
                <Container>
                    ...
                    <div className="login-main row mt-6 mb-7 row justify-content-center">
                        ...
                        <NavLink to="/login" className="nav-link text-center fs-14 fw-normal" style={{ marginTop: "50px" }}>ALREADY HAVE AN ACCOUNT ?</NavLink>
                    </div>
                </Container>
            </section>
            <ToastContainer />
