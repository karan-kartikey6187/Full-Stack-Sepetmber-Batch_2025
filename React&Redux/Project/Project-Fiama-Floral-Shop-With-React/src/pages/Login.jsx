...
import { schema } from '../assets/schemas/schema'

export const Login = () => {

    const { register, handleSubmit, reset, formState: { errors } } = useForm({ resolver: yupResolver(schema.pick(["password", "email"])) })
                    ...
                    <Row className="login-main mt-7 mb-7 px-4 px-lg-0">
                        ...
                        <div className="col-12 col-lg-6">
                            <div className="d-flex flex-column justify-content-center align-items-center" style={{ marginTop: "50px" }}>
                                ...
                                <NavLink to="/register" className="fw-medium px-5 py-2 text-center create-account-btn shop-now-btn btn rounded-0 btn-primary text-white text-nowrap text-decoration-none" role="button">CREATE ACCOUNT</NavLink>
                            </div>
                        </div>
                    </Row>
                </Container>
