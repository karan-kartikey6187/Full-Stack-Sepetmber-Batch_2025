...
import { ConvertToCurrency, toTitleCase } from "../utils/utils";
                    ...
                    <div className="border-bottom pb-4 mb-5">
                        <Row className="align-items-center ps-3 ps-sm-0">
                            ...
                            <Col md={6} className="text-md-end mt-3 mt-md-0">
                                <Button size="lg" className="mb-3 fw-semibold" variant="outline-success" onClick={() => navigate("/account")} >Back</Button>
