...
import { getOrdersByUser } from '../../api/Services';
                        ...
                        <tbody>
                            {orders.map((order, index) => (
                                <tr key={order.id}>
                                    ...
                                    <td className="p-2 fw-normal" role='button' onClick={() => navigate(`/order-details/${order.id}`)}><p className='p-0 m-0 nav-link'>View</p></td>
                                </tr>
                            ))}
                        </tbody>
                    </Table>
