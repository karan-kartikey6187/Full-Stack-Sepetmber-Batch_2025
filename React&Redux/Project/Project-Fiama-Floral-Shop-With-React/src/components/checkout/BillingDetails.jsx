...
import { schema } from 'src/assets/schemas/schema';
                ...
                <Form id="billingForm" className="mx-0 my-5" ref={refFrom} onSubmit={handleSubmit(handleSubmitForm)}>
                    ...
                    <Row className="mt-6 pt-5 mb-6">
                        ...
                        {cartState?.totalQuantities === 0 ?
                            <div className="cart-totals col-12 col-lg-6 mt-6 mt-lg-0 text-center fs-3 text-danger pt-7">No Item In Your Cart <br /><p className='mt-3'><NavLink to="/shop" className='fs-3 fw-semibold text-black text-decoration-none'><FaRegHandPointRight className='text-primary' /> Add Items</NavLink></p></div> :
